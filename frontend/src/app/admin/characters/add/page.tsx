...
export default function AddCharacterPage() {
  ...
  const generateCharacterId = () => {
    ...
    const generatedId = `${cleanName}-${randomSuffix}`
  ...
  const validateForm = (): string | null => {
    if (!formData.id.trim()) return 'Karakter ID gerekli'
  ...
  if (success) {
    return (
      <div className="max-w-2xl mx-auto mt-8 p-8 bg-white rounded-lg shadow text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Karakter Başarıyla Oluşturuldu!</h2>
        <p className="text-gray-600 mb-6">
          <strong>{formData.name}</strong> karakteri sisteme eklendi.
        </p>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Yeni Karakter Ekle</h1>
            <p className="text-gray-600">Tarihi bir karakter oluşturun ve sisteme ekleyin</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      placeholder="ataturk-001"
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                    <button
                      type="button"
                      onClick={generateCharacterId}
                  ...
                  <p className="text-xs text-gray-500 mt-1">Benzersiz tanımlayıcı (URL'lerde kullanılır)</p>
                </div>
            ...
            <div className="flex justify-end space-x-4">
              ...
              >
                ...
                <span>{loading ? 'Kaydediliyor...' : 'Karakteri Kaydet'}</span>
              </button>
            </div>
          </form>
        </div>
